...
class PatchEmbedding(nn.Module):
    ...
    def __init__(self, img_size : int, patch_size : int, dim : int, channels : int =2) -> None:
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size : int, patch_size : int, dim : int, depth : int, heads : int, mlp_dim : int, channels : int =2) -> None:
...
model = VisionTransformer(
    img_size=256, patch_size=16, dim=768, depth=12, heads=12, mlp_dim=3072
)
